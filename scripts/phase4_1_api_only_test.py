...
class APIOnlyModeEradicationTest:
    ...
    def run_all_tests(self) -> bool:
        ...
        tests = [
            ...
            ("API-onlyモードフォールバック無効化確認", self.test_no_api_only_mode_fallback),
        ...
        print(f"API-onlyモード根絶: {'✅ 完全根絶' if report['summary']['api_only_mode_eradicated'] else '❌ 未完了'}")
