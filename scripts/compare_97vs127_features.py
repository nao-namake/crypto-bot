...
class FeatureComparisonAnalyzer:
    ...
    def analyze_efficiency(self):
        ...
        time_improvement = ((time_127 - time_97) / time_127 * 100) if time_127 > 0 else 0
    ...
    def analyze_performance(self):
        ...
        if metrics_127.get('total_return', 0) != 0:
            return_retention = (metrics_97.get('total_return', 0) / 
                              metrics_127.get('total_return', 0) * 100)
        else:
            return_retention = 0
            
        if metrics_127.get('win_rate', 0) != 0:
            winrate_retention = (metrics_97.get('win_rate', 0) / 
                               metrics_127.get('win_rate', 0) * 100)
        else:
            winrate_retention = 0
