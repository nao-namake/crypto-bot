...
# Phase 22完了版：15特徴量最適化システム・625テスト品質保証
#
...
echo "🚀 新システム品質チェック開始 (Phase 22完了)"
echo "================================================="

# カバレッジ最低ライン（Phase 22最適化・55%目標設定）
COV_FAIL_UNDER=55

# Phase 22: 新システムディレクトリ構造確認
...
# Phase 22: 隠れた致命的障害検出（executor エラー等）
