...
| 2 | 特徴量数整合性 | feature_order.json vs metadata.json 一致確認（37特徴量） |
...
### MLモデル
- `models/production/ensemble_full.pkl`: 37特徴量モデル
- `models/production/ensemble_basic.pkl`: 37特徴量モデル
...
- `config/core/feature_order.json`: 37特徴量順序定義
