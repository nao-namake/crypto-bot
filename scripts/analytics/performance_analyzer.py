...
class PerformanceAnalyzer(BaseAnalyzer):
    ...
    def analyze_system_health(self, hours: int = 24) -> Dict:
        ...
        try:
            ...
            health_data = {"service_status": "ERROR", "error": str(e)}
    ...
    def analyze_error_logs(self, hours: int = 24) -> Dict:
        ...
        try:
            ...
            error_data = {"total_errors": 0, "error": str(e), "analysis_failed": True}
    ...
    def analyze_trading_performance(self, hours: int = 24) -> Dict:
        ...
        try:
            ...
            if success:
                ...
                success_rate = (
                    (order_counts["SUCCESS"] / total_orders * 100) if total_orders > 0 else 0
                )
    ...
    def generate_report(self, output_format: str = "json") -> str:
        ...
        if output_format == "json":
            ...
            # Markdownレポート生成
            with open(report_file, "w", encoding="utf-8") as f:
                f.write("# Phase 12 パフォーマンス分析レポート\n\n")
                ...
                f.write(
                    f"- **エラー率**: {error_analysis.get('error_rate_per_hour', 0):.2f}/時間\n"
                )
                ...
                f.write(
                    f"- **シグナル頻度**: {trading_perf.get('signal_frequency_per_hour', 0)}/時間\n"
                )
    ...
    def run_analysis(self, **kwargs) -> Dict:
        ...
        try:
            ...
            report_file = self.execute_full_analysis(period, output_format)
...
======================================"""
    ...
    def execute_full_analysis(self, period: str = "24h", output_format: str = "json") -> str:
        """完全分析実行（既存メソッド名前変更）"""
        logger.info(f"Phase 12パフォーマンス分析開始（期間: {period}）")
...
def main():
    ...
    parser.add_argument("--period", default="24h", help="分析期間 (例: 1h, 6h, 24h, 7d)")
    ...
    try:
        analyzer = PerformanceAnalyzer(
            project_id=args.project, service_name=args.service, region=args.region
        )

        report_file = analyzer.execute_full_analysis(period=args.period, output_format=args.format)
