"""
Kelly基準ポジションサイジングモジュール

Phase 6リスク管理層の中核機能。Kelly公式による理論的最適ポジションサイズ
の計算と、実用的な安全制約の適用を行います。

レガシーシステムの優秀な機能を統合:
- Dynamic position sizing (ボラティリティ連動)
- 複数レベルフォールバック機能
- 強化された安全制限
...
class KellyCriterion:
    ...
    def calculate_dynamic_position_size(
        ...
        レガシーシステムの優秀な機能を統合。ボラティリティに応じて
        ポジションサイズを調整し、高ボラ時は小さく、低ボラ時は大きくする。
        ...
        try:
            ...
            # 2) ATRベースのストップロス計算（レガシー手法を活用）
            stop_atr_multiplier = 2.0  # デフォルト
