...
LOW_VOL_CONFIDENCE_MULTIPLIER = 1.0  # Phase 55.2: 1.2 → 1.0（HOLD優勢化防止）
...
class StrategyManager:
    ...
    def _create_hold_signal(self, df: pd.DataFrame, reason: str = "条件不適合") -> StrategySignal:
        ...
        # Phase 54.12: デフォルト値を0.35に修正（thresholds.yaml:161と整合性確保）
        base_confidence = get_threshold("ml.dynamic_confidence.base_hold", 0.35)
