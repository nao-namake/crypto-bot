...
**Phase 53完了・bitbank BTC/JPY専用・GCP稼働率100%達成**

[![Tests](https://img.shields.io/badge/tests-1191%20passed-success)](tests/)
[![Coverage](https://img.shields.io/badge/coverage-65.42%25-green)](coverage-reports/)
[![Phase](https://img.shields.io/badge/Phase%2053-Completed-brightgreen)](docs/)
...
# 品質チェック
bash scripts/testing/checks.sh  # 1,191テスト・65.42%カバレッジ
...
- **pytest**: 1,191テスト100%成功
- **coverage**: 65.42%カバレッジ
...
- **[CLAUDE.md](CLAUDE.md)**: 開発ガイド・品質基準・ドキュメント索引
