...
## システム現状（Phase 62.18完了）

### 概要

| 項目 | 値 |
|------|-----|
| **Phase** | 62.18完了（SLパターン分析機能）|
...
| 区分 | 内容 | 効果 |
|------|------|------|
| **Maker戦略** | エントリー/TP決済でMaker約定 | 往復手数料-0.04%（0.28%削減） |
...
| 項目 | エントリー | TP決済 | SL決済 |
|------|----------|--------|--------|
| 手数料率 | -0.02%（Maker） | -0.02%（Maker） | 0.12%（Taker） |
| **往復（TP時）** | **-0.04%** | - | - |
| **往復（SL時）** | **0.10%** | - | - |
...
**📅 最終更新**: 2026年2月6日 - **Phase 62.18完了**・SLパターン分析機能・exit記録欠損修正
