...
| 項目 | 値 |
|------|-----|
| **現在Phase** | 73-D（MLメタラベリング導入・取引品質フィルタ） |
| **直前の作業** | Phase 71-73: DonchianChannel無効化 / レジーム修正 / CMF,CCI,WR追加 / バイナリ→メタラベリング / 12ヶ月データ |
| **次の予定** | ライブ検証（24-48時間）→ Phase 74（適応型システム） |
| **最新成果** | メタラベリング: BL比+1.8pt / 予測偏り解消 / 過学習4.5% / 0.60+精度72.7% / 期待値+456円/取引 |
| **最終更新** | 2026年3月29日 |
...
| **証拠金** | 50万円 |
| **年利目標** | 10%（DD 10%許容） |
| **戦略数** | 5戦略（レンジ型3 + トレンド型2、DonchianChannel無効化） |
| **特徴量数** | 55特徴量（49基本 + 6戦略信号、CMF/CCI/Williams%R含む） |
