...
| 項目 | 値 |
|------|-----|
| **現在Phase** | 83B（TP1000/SL500/floor撤廃・RR比2.0:1）設定変更+ML再学習完了 |
| **直前の作業** | Phase 83B-ML: meta_tp=0.6%/meta_sl=0.45%でML再学習（コミット待ち） |
| **次の予定** | コミット→デプロイ→14日観測 → 勝率・RR比・損益確認 |
| **最新成果** | 14日損益-8,522円の主因はSL平均-1,637円。SL500/TP1000で推定+25,000円改善 |
| **最終更新** | 2026年5月8日 |
