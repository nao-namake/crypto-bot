...
class StrategyFactory:
    ...
    @staticmethod
    def create_multi_strategy(configs: List[Dict[str, Any]], 
                            combination_mode: str = "weighted_average") -> StrategyBase:
        """
    ...
    def validate_config(config: Dict[str, Any]) -> List[str]:
        ...
        for param_name, param in sig.parameters.items():
            if (param_name != 'self' and 
                ...
                param_name != 'config'):
                errors.append(f"Required parameter '{param_name}' is missing for strategy '{strategy_name}'")
