"""
ML Feature Engineer - Phase 16.3-A Split

統合前: crypto_bot/ml/preprocessor.py（3,314行）
分割後: crypto_bot/ml/preprocessing/feature_engineer.py

機能:
- FeatureEngineer: OHLCV→特徴量変換sklearn互換クラス
- ATR, lag, rolling統計, extra_features対応
- Phase 3対応: 外部API依存除去・97特徴量システム統合
