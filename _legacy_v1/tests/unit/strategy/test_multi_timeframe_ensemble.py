...
class TestMultiTimeframeEnsembleStrategy(unittest.TestCase):
    ...
    def test_timeframe_data_generation(self):
        ...
        self.assertGreater(
            len(data_15m), len(self.price_df)
        )  # より多くのデータポイント
    ...
    def test_timeframe_ensemble_predictions(self, mock_ensemble_strategy):
        ...
        mock_ensemble_strategy.side_effect = lambda **kwargs: mock_strategies[
    ...
    def test_dynamic_threshold_calculation(self):
        ...
        # 高品質・高合意度
        high_quality_info = {"total_weight": 1.0, "signal_consensus": 0.9}
        high_quality_threshold = strategy._calculate_multi_timeframe_threshold(
            high_quality_info
        )

        # 低品質・低合意度
        low_quality_info = {"total_weight": 0.5, "signal_consensus": 0.4}
    ...
    def test_final_signal_decision_entry(self, mock_ensemble_strategy):
        ...
        high_consensus_info = {"signal_consensus": 0.8, "total_weight": 1.0}
    ...
    def test_final_signal_decision_exit(self, mock_ensemble_strategy):
        ...
        # 弱いシグナル
        weak_signal = 0.3
        normal_info = {"signal_consensus": 0.6, "total_weight": 0.8}
    ...
    def test_multi_ensemble_info_retrieval(self):
        ...
        strategy.prediction_history = [
            {"integrated_signal": 0.7, "signal_info": {"signal_consensus": 0.8}}
        ]
    ...
    def test_recent_performance_analysis(self):
        ...
        recent_predictions = [
            {"integrated_signal": 0.7, "signal_info": {"signal_consensus": 0.8}},
            {"integrated_signal": 0.6, "signal_info": {"signal_consensus": 0.7}},
            {"integrated_signal": 0.8, "signal_info": {"signal_consensus": 0.9}},
        ]
