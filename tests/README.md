...
**Phase 12完了**: システム全体の品質保証を担当するテストコードが格納されています。段階的開発に対応したテスト戦略・CI/CDワークフロー最適化・手動実行監視・品質ゲートを採用し、316テスト・68.13%合格を達成しています。
...
│   └── README.md                     # 手動テスト説明 ✅
├── unit/             # 単体テスト ✅ Phase 12完了（316テスト・68.13%合格・CI/CDワークフロー最適化）
│   ├── strategies/   # 戦略テスト（113テスト・100%合格・CI/CDワークフロー最適化）
...
│   │   ├── ensemble/        # アンサンブルテスト
│   │   └── README.md        # MLテスト詳細 ✅
│   ├── backtest/     # バックテストテスト（84テスト・100%合格）✅ Phase 12 CI/CD対応
...
│   │   └── README.md               # 取引テスト詳細 ✅
│   ├── core/         # 基盤システムテスト（Phase 12完了）
│   ├── data/         # データ層テスト（Phase 12完了）
│   └── features/     # 特徴量テスト（Phase 12完了）
...
**unit/trading/**（113テスト・100%合格）✅ Phase 12完了:
- ✅ リスク管理テスト: Kelly基準・ドローダウン制御・異常検知・CI/CDワークフロー最適化
