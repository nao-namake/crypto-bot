...
class TestEnsembleModel:
    ...
    def test_ensemble_model_initialization_stacking(self, simple_models):
        ...
        ensemble = EnsembleModel(simple_models, method="stacking", meta_model=meta_model)
    ...
    def test_ensemble_model_predict_proba_voting(self, simple_models, ensemble_test_data):
        """多数決方式での確率予測テスト"""
        from crypto_bot.ml.model import EnsembleModel
    ...
    def test_ensemble_model_predict_proba_weighted(self, simple_models, ensemble_test_data):
        """重み付き方式での確率予測テスト"""
        from crypto_bot.ml.model import EnsembleModel
    ...
    def test_ensemble_model_predict_proba_stacking(self, simple_models, ensemble_test_data):
        """スタッキング方式での確率予測テスト"""
        from crypto_bot.ml.model import EnsembleModel
    ...
    def test_ensemble_model_predict_proba_before_fit(self, simple_models, ensemble_test_data):
        """学習前の確率予測エラーテスト"""
        from crypto_bot.ml.model import EnsembleModel
    ...
    def test_ensemble_model_save_load(self, tmp_path, simple_models, ensemble_test_data):
...
class TestCreateEnsembleModel:
    ...
    def test_create_ensemble_model_weighted(self, model_configs):
        ...
        weights = [0.5, 0.3, 0.2]
        ensemble = create_ensemble_model(model_configs, method="weighted", weights=weights)
    ...
    def test_create_ensemble_model_stacking_custom_meta(self, model_configs):
        ...
        ensemble = create_ensemble_model(model_configs, method="stacking", meta_model_config=meta_config)
...
class TestAdvancedMLModel:
    ...
    def test_mlmodel_ensemble_integration(self, dummy_classification_data):
        ...
        from crypto_bot.ml.model import MLModel, EnsembleModel, create_model
...
class TestEdgeCases:
    ...
    def test_ensemble_model_weights_none_handling(self, dummy_classification_data):
        ...
        X, y = dummy_classification_data
        models = [create_model("rf", n_estimators=5), create_model("lgbm", n_estimators=5)]
