# 運用マニュアル - crypto-bot 新システム（Phase 13完了版・スクリプト統合）

## 📋 概要

**作成日**: 2025年8月22日（最終更新）  
**対象システム**: crypto-bot 新システム（Phase 13完了・スクリプト統合（9→5フォルダ）・sklearn警告解消・logs統合・models整理）  
**運用環境**: GCP Cloud Run + CI/CD本番稼働・306テスト100%・24時間監視・段階的デプロイ・品質保証完成  
**対象者**: システム運用者・開発者・緊急時対応担当者

このマニュアルは、Phase 13完了システムでのスクリプト統合（9→5フォルダ・44%削減）・sklearn警告解消・品質保証完成・CI/CD本番稼働での日常運用・緊急時対応・ロールバック手順を包括的に定義します。
...
**期待結果**:
- ✅ Phase 13実装完了（スクリプト統合・sklearn警告解消・logs統合・models整理）
- ✅ 306テスト100%成功（品質保証完成）
- ✅ 統合品質チェック合格（6段階すべて）
- ✅ GitHub Actions CI/CD本番稼働・監視ワークフロー正常
...
**最終更新**: 2025年8月22日 - Phase 13完了時（スクリプト統合・sklearn警告解消）