...
このマニュアルは、Phase 13完了システムでのconfig構造最適化・モード統一・品質保証完成・CI/CD完全自動化での日常運用・緊急時対応・ロールバック手順を包括的に定義します。
...
# 3. 個別コンポーネント確認
python3 -c "from src.ml.ensemble.production_ensemble import ProductionEnsemble; print('✅ Ensemble OK')"
```
