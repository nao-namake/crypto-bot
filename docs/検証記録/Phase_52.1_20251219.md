...
- **バックテスト期間**: 2025/06/22 ~ 2025/12/19 (0日間)
...
|---------|------------|------|-------------|--------|
| レンジ（狭） | 79件 | 65.8% | ¥+5 | ¥+433 |
| レンジ（通常） | 11件 | 63.6% | ¥+6 | ¥+70 |
...
| 指標 | 値 | 判定基準 |
|------|-----|---------|
| シャープレシオ | 34.00 | 優秀（≥1.0で良好） |
| 期待値 | ¥+6 | 良好（>0で収益期待） |
| リカバリーファクター | 15.45 | 優秀（≥1.0でDD回復） |

### 参考指標

| 指標 | 値 | 説明 |
|------|-----|------|
| ソルティノレシオ | 64.55 | 下方リスク調整リターン |
| カルマーレシオ | 19.15 | 年率リターン/最大DD |
