...
|---------|------------|------|-------------|--------|
| レンジ（狭） | 123件 | 56.1% | ¥+3 | ¥+380 |
| レンジ（通常） | 8件 | 87.5% | ¥+12 | ¥+98 |
...
| 指標 | 値 | 判定基準 |
|------|-----|---------|
| シャープレシオ | 22.87 | 優秀（≥1.0で良好） |
| 期待値 | ¥+4 | 良好（>0で収益期待） |
| リカバリーファクター | 13.59 | 優秀（≥1.0でDD回復） |

### 参考指標

| 指標 | 値 | 説明 |
|------|-----|------|
| ソルティノレシオ | 41.49 | 下方リスク調整リターン |
| カルマーレシオ | 13.11 | 年率リターン/最大DD |
