...
- **バックテスト期間**: 2025/06/20 ~ 2025/12/17 (0日間)
...
| 指標 | 値 | 説明 |
|------|-----|------|
| ソルティノレシオ | 36.99 | 下方リスク調整リターン |
| カルマーレシオ | 16.92 | 年率リターン/最大DD |
