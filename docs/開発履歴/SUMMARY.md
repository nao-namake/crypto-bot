...
| **60** | **レバレッジ最適化期** | 2026/1/19- | **実効レバレッジ0.15→0.5倍移行・年利75%目標** | [詳細](Phase_60.md) |
...
| 項目 | 成果 |
|------|------|
| **Stacking検証** | Stacking vs PE比較→PE採用（+12-25%高収益） |
| **最終結果** | ¥+54,526（過去最高）、勝率53.2%、PF 1.60 |
| **年利換算** | 10.9%（半年）→ 22.9%（年間複利）※目標10%大幅超過 |
| **2票ルール無効化** | 重みづけ統合方式採用（PF 1.55→1.60に改善） |
| **信頼度修正** | penalty 0.96→0.80、bonus 1.18→1.10 |
| **BBReversal改修** | normal_range無効化（0%勝率→除外） |
