...
| **59** | **戦略改善期** | 2026/1/13 | **BBReversal normal_range無効化・信頼度penalty/bonus修正** | [詳細](Phase_59.md) |
...
| 項目 | 成果 |
|------|------|
| **BBReversal改修** | normal_range無効化（0%勝率→除外）、tight_range維持（58.3%勝率） |
| **信頼度修正** | penalty 0.96→0.80、bonus 1.18→1.10、閾値引き上げ |
| **DonchianChannel** | 無効化計画撤回（TP/SL変更で黒字化: +¥6,711） |
| **基準値（Phase 58.6）** | ¥+35,105、勝率50.9%、PF 1.38 |
